# central Agrofoods training - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **central Agrofoods training**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@centralagrofoodstraining.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@centralagrofoodstraining.cm` | `user123` | |
...
*   **Contact :** contact@centralagrofoodstraining.cm